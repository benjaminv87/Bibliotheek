    ...
    public partial class FormBoekenInfo : Form
    {
        ...
        private void BoekenInfo_Load(object sender, EventArgs e)
        {
            using(BoekenEntities ctx= new BoekenEntities())
            {
                ...
                //BoekenAuteurs auteurID = ctx.BoekenAuteurs.Where(ba => ba.BoekId == MijnBoekID).FirstOrDefault();
                //Auteurs auteur = ctx.Auteurs.Where(a => a.Id == auteurID.AuteurId).FirstOrDefault();
